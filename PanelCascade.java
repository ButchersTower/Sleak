...
public class PanelCascade extends JPanel implements MouseListener, KeyListener,
		MouseMotionListener {
	...
	void roundSleak() {
		...
		g.fillOval(panelInfo[0] + panelInfo[2] - 18, panelInfo[1] + 2, 12, 12);
	}
